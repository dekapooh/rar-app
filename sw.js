const CACHE_NAME="rar-reference-v1-data-v11";
const APP_SHELL=[
  "./","./index.html","./manifest.webmanifest","./icon-192.png","./icon-512.png","./hero-rc65.png","./brand-horse-rc65.png","./data/rar-data-reference-v1.json"
];
